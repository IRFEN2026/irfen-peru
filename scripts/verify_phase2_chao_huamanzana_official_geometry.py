...
def main():
 ...
 req={"status":"PASS_OFFICIAL_ANA_DISCOVERY_CHILD_GEOMETRY","component_id":p.CID,"ana_unit_code":p.CODE,"ana_unit_name":p.ANA_NAME,"display_name":p.DISPLAY_NAME,"source_sha256":src,"geometry_sha256":gsha,"outcomes_read":False,"event_footprint_created":False,"rainfall_read":False,"hydraulic_capacity_read":False,"thresholds_used":False,"negative_controls_read":False,"approximate_geometry_used":False,"chorobal_geometry_inferred":False,"parent_composite_created":False}
 ...
 if kids[p.CID].get("ana_unit_name")!=p.ANA_NAME or p.DISPLAY_NAME not in kids[p.CID].get("name_aliases",[]):fail("OFFICIAL_NAME_ALIAS_DRIFT")
