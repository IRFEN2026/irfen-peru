#!/usr/bin/env python3
"""Freeze exact ANA Cuenca Huamanzaña geometry as one Chao discovery child only."""
...
DID="lalibertad_chao_huamanzaña_chorobal"; CID="huamanzaña_basin_context"; CODE="137712"; NAME="Cuenca Huamanzaña"
...
SOURCE=ROOT/"site/data/phase2/sources/north_coast_discovery_geometry/ana_lalibertad_huamanzana_137712.geojson"
GEOM=ROOT/"site/data/phase2/geometries/lalibertad_huamanzaña_basin_context.geojson"; VAL=ROOT/"site/data/phase2/geometries/lalibertad_huamanzaña_basin_context_validation.json"
...
def validate(c,p):
 ...
 kids={x["child_id"]:x for x in p.get("hydrologic_children",[])}
 if set(kids)<={""}:raise E("NO_CHILDREN")
 hu=kids.get(CID);ch=kids.get("chorobal_river_component")
 if not hu or hu.get("ana_unit_code")!=CODE or hu.get("name")!=NAME:raise E("HUAMANZANA_IDENTITY_DRIFT")
