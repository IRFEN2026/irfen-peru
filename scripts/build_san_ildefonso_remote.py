...
def delineate(dem,tr):
    ...
    feat={"type":"Feature","properties":{
        ...
        "note":"Candidato condicionado por el área de referencia; requiere validación visual ANA antes de producción."
    ...
    rep={"zone_id":"san_ildefonso","status":status,"dataset":"Copernicus DEM GLO-30 Public",
         ...
         "decision":"candidate_for_visual_review" if status!="FAIL" else "do_not_use"}
