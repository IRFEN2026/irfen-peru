...
def check_authoritative_geometry_state(catalog):
    ...
    if present != {SANTA_ID, LURIN_ID, MOTUPE_ID, ACARI_ID, CANETE_ID, ASIA_ID}:
    ...
    for cid in (SANTA_ID, LURIN_ID, MOTUPE_ID, ACARI_ID, CANETE_ID, ASIA_ID):
...
def check_artifact(result, inventory):
    ...
    expected_summary = {
        ...
        "non_catchment_geometry_only_count": 5,
