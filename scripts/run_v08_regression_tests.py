...
def main():
    ...
    check('closeout_shadow_schedule_covers_pre_day_window','cron: "12 0,12,14,16,18,20,22 * * *"' in shadow_workflow)
    retry_crons=shadow_capture.get('redundant_retry_crons_utc') or []
    check('closeout_shadow_redundant_capture_attempts_declared',retry_crons==['52 0 * * *','32 1 * * *'])
